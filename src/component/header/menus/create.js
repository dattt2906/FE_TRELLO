...
export default function Create() {
    ...
    const handleCreateBoard = () => {
        axios.post("http://localhost:3001/board/create-board", { boardname, workspaceId }).then(res => {
            if (res.data) {
                console.log("create board sucess")
    ...
    return (
        <>
            ...
            <Box sx={{ height: "fit-content", width: "300px", marginTop: "345px", position: "absolute", marginLeft: "770px", backgroundColor: "hsla(260, 80%, 94.1%, 0.9)", display: isShowModalAddBoard ? "block" : "none" }}>
