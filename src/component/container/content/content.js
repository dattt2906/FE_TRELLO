...
import { findBoardById } from "../../../service/api/common";
...
const Content = () => {
  ...
  const getData = async () => {
    ...
    //   }
    // });
    const res = await findBoardById(boardId);
    if (res) {
      setColumns(res.cols);
      setBoardBackground(res.boardbackground);
    }
  };
              ...
              {isAddColumn === false ?
                ...
                <div className="content-add-column">
                  <div className="text-area-add-column">
                    ...
                    <Textarea placeholder="Enter the list title"
                              sx={{ width: "280px", marginLeft: "10px", marginTop: "10px" }}
                              onChange={(e) => setColumnName(e.target.value)}></Textarea>
                  </div>
