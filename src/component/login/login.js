    ...
    <>
      ...
      <Box sx={{
        ...
        <Box sx={{ marginTop: "50px", display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <span
            style={{ fontSize: "25px", fontFamily: "var(--font-family-text,'Charlie Text',sans-serif)" }}>Trello</span>
        </Box>
        ...
        <Box
          ...
          autoComplete="off"
        >
          <TextField type="text" id="outlined-basic" label="Email" variant="outlined"
